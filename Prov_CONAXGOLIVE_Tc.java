...
public class Prov_CONAXGOLIVE_Tc extends MQProvisioning

{
			...
			String Prov_System_Name="CONAXGOLIVE";
			String Prov_System_Code="CONAXGOLIVE";
			String Eff_date="30-07-2019";
			String Plan_code="CONAXGOLIVE" ;

			protected Prov_CONAXGOLIVE_Tc(String sLogFileName) throws Exception 
			{
				super(sLogFileName);
			...
			public void PR_2660() throws Exception
			{
				try
				{
					...
					if(PricePlan_Count==0)  
					{
						...
						Thread.sleep(1000);
						oPricePlan.PricePlanCreation(chargeUnit,Plan_code,Plan_code,"",Prov_System_Name,"","","","",locPlanType,"One Month"," "," ","",""," ","","Basic",""," "," ","","dfse",locSaveOrCancelBtn,locpricingBtn,Eff_date,locPrice,locPricingSaveBtn);
