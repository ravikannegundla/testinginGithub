...
public class Prov_NORDIJA_Tc extends MQProvisioning

{
			...
			String Prov_System_Name="NORDIJA";
			String Prov_System_Code="NORDIJA";
			String Eff_date="02-08-2019";
			String Plan_code="NORDIJA" ;

			protected Prov_NORDIJA_Tc(String sLogFileName) throws Exception 
			{
				super(sLogFileName);
