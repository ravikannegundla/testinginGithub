...
public class Prov_GOSPELLV3P7_Tc  extends MQProvisioning

{
			...
			String Prov_System_Name="GOSPELLV3P7";
			String Prov_System_Code="GOSPELLV3P7";
			String Eff_date="26-07-2019";
			String Plan_code="GOSPELLV3P7" ;

			protected Prov_GOSPELLV3P7_Tc(String sLogFileName) throws Exception 
			{
				super(sLogFileName);
			...
			public void PR_2660() throws Exception
			{
				try
				{
					...
					if(PricePlan_Count==0)  
					{
						...
						Thread.sleep(1000);
						oPricePlan.PricePlanCreation(chargeUnit,Plan_code,Plan_code,"",Prov_System_Name,"","","","",locPlanType,"One Month"," "," ","",""," ","","Basic",""," "," ","","DHEWB",locSaveOrCancelBtn,locpricingBtn,Eff_date,locPrice,locPricingSaveBtn);
			...
			public void PR_2662() throws Exception
			{
				try
				{
					...
					relogin();
					Thread.sleep(2000);
					CustomerNumber=oBasicConfigurationsOfProvisioning.CustomerActvation("N", "Own", "", "",contract_validity,Plan_code,"",billing_Frequency);
