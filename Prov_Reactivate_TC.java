...
public class Prov_Reactivate_TC extends MQProvisioning

{
			...
			protected Prov_Reactivate_TC(String sLogFileName) throws Exception
			{
				super(sLogFileName);
...
oOrderManagementPrivileges.ServiceOrder_privileges();
			...
			@Test(description="Active stage definition")
			public void PR_4069() throws Exception
			{
				try
				{
					...
					if(Qstatus.equalsIgnoreCase(Provisioned_Status))
					{
						...
						testLinkConnection.setsNotes("Active stage definition is Passed");
					}
					else
					{
						System.out.println("PR-4069 Failed");
						testLinkConnection.setsResult(TestLinkAPIResults.TEST_FAILED);
						testLinkConnection.setsNotes("Active stage definition is failed");
					}
				}
				catch(Exception e)
				{
			...
			@Test(description="Reactivate after Service downgrade(Single Contract)")
			public void PR_5075() throws Exception
			{
				try
				{
					...
					if(Qstatus.equalsIgnoreCase(C_Status))  
					{
						...
						testLinkConnection.setsResult(TestLinkAPIResults.TEST_PASSED);
						testLinkConnection.setsNotes("Reactivate after Service downgrade(Single Contract) is passed");
					}
					else
					{
						System.out.println("PR-5075 Failed");
						testLinkConnection.setsResult(TestLinkAPIResults.TEST_FAILED);
						testLinkConnection.setsNotes("Reactivate after Service downgrade(Single Contract) is failed");
					}
				}
				catch(Exception e)
				{
			...
			@Test(description="Reactivate after Service downgrade(Multi Contract)")
			public void PR_5076() throws Exception
			{
				try
				{
					...
					if(Qstatus.equalsIgnoreCase(C_Status))  
					{
						...
						testLinkConnection.setsResult(TestLinkAPIResults.TEST_PASSED);
						testLinkConnection.setsNotes("Reactivate after Service downgrade(Multi Contract) is Passed");
					}
					else
					{
						System.out.println("PR-5076 Failed");
						testLinkConnection.setsResult(TestLinkAPIResults.TEST_FAILED);
						testLinkConnection.setsNotes("Reactivate after Service downgrade(Multi Contract) is Failed");
					}
				}
				catch(Exception e)
				{
			...
			@Test(description="Reactivate after Service downgrade(Multi Room)")
			public void PR_5077() throws Exception
			{
				try
				{
					...
					if(Qstatus.equalsIgnoreCase(C_Status))  
					{
						...
						testLinkConnection.setsResult(TestLinkAPIResults.TEST_PASSED);
						testLinkConnection.setsNotes("Reactivate after Service downgrade(Multi Room) is Passed");
					}
					else
					{
						System.out.println("PR-5077 Failed");
						testLinkConnection.setsResult(TestLinkAPIResults.TEST_FAILED);
						testLinkConnection.setsNotes("Reactivate after Service downgrade(Multi Room) is failed");
					}
				}
				catch(Exception e)
				{
			...
			@Test(description="Reactivate after Service downgrade(Single contract with is _bulk as Y)")
			public void PR_4055() throws Exception
			{
				try
				{
					...
					if(Qstatus.equalsIgnoreCase(C_Status))  
					{
						...
						testLinkConnection.setsResult(TestLinkAPIResults.TEST_PASSED);
						testLinkConnection.setsNotes("Reactivate after Service downgrade(Single contract with is _bulk as Y) is Passed");
					}
					else
					{
						System.out.println("PR-4055 Failed");
						testLinkConnection.setsResult(TestLinkAPIResults.TEST_FAILED);
						testLinkConnection.setsNotes("Reactivate after Service downgrade(Single contract with is _bulk as Y) is Failed");
					}
				}
				catch(Exception e)
				{
			...
			@Test(description="Suspend after Reactivate")
			public void PR_4078() throws Exception
			{
				try
				{
					...
					if(Qstatus.equalsIgnoreCase(C_Status))
					{
						...
						testLinkConnection.setsResult(TestLinkAPIResults.TEST_PASSED);
						testLinkConnection.setsNotes("Suspend after Reactivate is Passed");
					}
					else
					{
						System.out.println("PR-4078 Failed");
						testLinkConnection.setsResult(TestLinkAPIResults.TEST_FAILED);
						testLinkConnection.setsNotes("Suspend after Reactivate is Failed");
					}
				}
				catch(Exception e)
				{
			...
			@Test(description="Retracking after Reactivate")
			public void PR_4079() throws Exception
			{
				try
				{
					...
					if(Qstatus.equalsIgnoreCase(C_Status))
					{
						...
						testLinkConnection.setsResult(TestLinkAPIResults.TEST_PASSED);
						testLinkConnection.setsNotes("Retracking after Reactivate is Passed");
					}
					else
					{
						System.out.println("PR-4079 Failed");
						testLinkConnection.setsResult(TestLinkAPIResults.TEST_FAILED);
						testLinkConnection.setsNotes("Retracking after Reactivate is Failed");
					}
				}
				catch(Exception e)
				{
