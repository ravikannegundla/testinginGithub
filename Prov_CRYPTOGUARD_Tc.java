...
public class Prov_CRYPTOGUARD_Tc  extends MQProvisioning

{
			...
			String Prov_System_Name="CRYPTOGUARD";
			String Prov_System_Code="CRYPTOGUARD";
			String Eff_date="30-07-2019";
			String Plan_code="CRYPTOGUARD" ;

			protected Prov_CRYPTOGUARD_Tc(String sLogFileName) throws Exception 
			{
				super(sLogFileName);
...
*/
			...
			public void PR_2660() throws Exception
			{
				try
				{
					...
					if(PricePlan_Count==0)  
					{
						...
						Thread.sleep(1000);
						oPricePlan.PricePlanCreation(chargeUnit,Plan_code,Plan_code,"",Prov_System_Name,"","","","",locPlanType,"One Month"," "," ","",""," ","","Basic",""," "," ","","DFSZ",locSaveOrCancelBtn,locpricingBtn,Eff_date,locPrice,locPricingSaveBtn);
			...
			public void PR_2661() throws Exception
			{
				try
				{
					...
					Thread.sleep(2000);
					oActivityPrerequisites.ProvActivityPrerequisitesMapping(Prov_System_Name,Service_Class,"1","157","Pre Action","Y",1);
					oActivityPrerequisites.ProvActivityPrerequisitesMapping(Prov_System_Name,Service_Class,"1","12","Pre Action","N",2);
					oActivityPrerequisites.ProvActivityPrerequisitesMapping(Prov_System_Name,Service_Class,"1","10","Pre Action","Y",3);
					
					oActivityPrerequisites.ProvActivityPrerequisitesMapping(Prov_System_Name,Service_Class,"83","157","Pre Action","Y",4);
					oActivityPrerequisites.ProvActivityPrerequisitesMapping(Prov_System_Name,Service_Class,"83","12","Pre Action","N",5);
					oActivityPrerequisites.ProvActivityPrerequisitesMapping(Prov_System_Name,Service_Class,"83","10","Pre Action","Y",6);
