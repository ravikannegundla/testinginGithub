...
public class Prov_ABEL4P2_Tc extends MQProvisioning

{
			...
			String Prov_System_Name="ABEL4P2";
			String Prov_System_Code="ABEL4P2";
			String Eff_date="29-07-2019";
			String Plan_code="ABEL4P2" ;

			protected Prov_ABEL4P2_Tc(String sLogFileName) throws Exception 
			{
				super(sLogFileName);
