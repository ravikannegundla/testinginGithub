...
public class Prov_KINGVON_Tc extends MQProvisioning

{
			...
			String Prov_System_Name="KINGVON";
			String Prov_System_Code="KINGVON";
			String Eff_date="01-08-2019";
			String Plan_code="KINGVON" ;

			protected Prov_KINGVON_Tc(String sLogFileName) throws Exception 
			{
				super(sLogFileName);
			...
			public void PR_2660() throws Exception
			{
				try
				{
					...
					if(PricePlan_Count==0)  
					{
						...
						Thread.sleep(1000);
						oPricePlan.PricePlanCreation(chargeUnit,Plan_code,Plan_code,"",Prov_System_Name,"","","","",locPlanType,"One Month"," "," ","",""," ","","Basic",""," "," ","","dsdz",locSaveOrCancelBtn,locpricingBtn,Eff_date,locPrice,locPricingSaveBtn);
			...
			public void PR_2661() throws Exception
			{
				try
				{
					...
					Thread.sleep(2000);
					oActivityPrerequisites.ProvActivityPrerequisitesMapping(Prov_System_Name,Service_Class,"156","157","Pre Action","Y",1);
					oActivityPrerequisites.ProvActivityPrerequisitesMapping(Prov_System_Name,Service_Class,"156","13","Pre Action","Y",2);
					oActivityPrerequisites.ProvActivityPrerequisitesMapping(Prov_System_Name,Service_Class,"156","10","Pre Action","N",3);
					oActivityPrerequisites.ProvActivityPrerequisitesMapping(Prov_System_Name,Service_Class,"129","9","Post Action","N",4);
					oActivityPrerequisites.ProvActivityPrerequisitesMapping(Prov_System_Name,Service_Class,"129","87","Post Action","Y",5);
