			...
			public void PR_2544() throws Exception
			{
				try
				{
					...
					if(Qstatus.equalsIgnoreCase(C_Status))
					{
						...
						testLinkConnection.setsResult(TestLinkAPIResults.TEST_PASSED);
						testLinkConnection.setsNotes("Disconnection Agreement-Remove Product is Done");
					}
					else
					{
			...
			public void PR_2547() throws Exception
			{
				...
				try
				{
					...
					if(Qstatus.equalsIgnoreCase(C_Status))
					{
						...
						testLinkConnection.setsResult(TestLinkAPIResults.TEST_PASSED);
						testLinkConnection.setsNotes("Hardware Change -Hw Add Product is Passed");
					}
					else
					{
						System.out.println("PR-2547 Failed");
						testLinkConnection.setsResult(TestLinkAPIResults.TEST_FAILED);
						testLinkConnection.setsNotes("Hardware Change -Hw Add Product is Failed");
					}
				}
				catch(Exception e)
				{
			...
			public void PR_2549() throws Exception
			{
				try
				{
					...
					if( Screen_Validation.length()!=0 )
					{
						...
						testLinkConnection.setsResult(TestLinkAPIResults.TEST_PASSED);
						testLinkConnection.setsNotes("Provision Actions - Product Link Actions is Passed");
					}
					else
					{
						System.out.println("PR-2549 Failed");
						testLinkConnection.setsResult(TestLinkAPIResults.TEST_FAILED);
						testLinkConnection.setsNotes("Provision Actions - Product Link Actions is Failed");
					}
				}
				catch(Exception e)
				{
			...
			public void PR_2554() throws Exception
			{
				try
				{
					...
					if(Qstatus.equalsIgnoreCase(C_Status))        	
					{
						...
						testLinkConnection.setsResult(TestLinkAPIResults.TEST_PASSED);
						testLinkConnection.setsNotes("Suspend Agreement with suspend Product List is Passed");
					}
					else
					{
						System.out.println("PR-2554 Failed");
						testLinkConnection.setsResult(TestLinkAPIResults.TEST_FAILED);
						testLinkConnection.setsNotes("Suspend Agreement with suspend Product List is Failed");
					}
				}
				catch(Exception e)
				{
			...
			public void PR_2555() throws Exception
			{
				try
				{
					...
					if(Qstatus.equalsIgnoreCase(C_Status))
					{
						...
						testLinkConnection.setsResult(TestLinkAPIResults.TEST_PASSED);
						testLinkConnection.setsNotes("Reactivate Agreement with reactivate Product List is Passed");
					}
					else
					{
						System.out.println("PR-2555 Failed");
						testLinkConnection.setsResult(TestLinkAPIResults.TEST_FAILED);
						testLinkConnection.setsNotes("Reactivate Agreement with reactivate Product List is Failed");
					}
				}
				catch(Exception e)
				{
			...
			public void PR_2557() throws Exception
			{
				try
				{
					...
					if(Qstatus.equalsIgnoreCase(C_Status))
					{
						...
						testLinkConnection.setsResult(TestLinkAPIResults.TEST_PASSED);
						testLinkConnection.setsNotes("Retrack is Passed");
					}
					else
					{
