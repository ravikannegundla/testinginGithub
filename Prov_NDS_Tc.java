...

{
			...
			String Prov_System_Code="NDS";
			String Eff_date="02-08-2019";
			String Plan_code="NDS" ;
			...
			public void PR_2262() throws Exception
			{
				try
				{
					...
					System.out.println("Price Plan Count is "+PricePlanCount);
					int PricePlan_Count = Integer.parseInt(PricePlanCount);
					System.out.println("Price Plan Count is "+PricePlan_Count);
					...
					if(PricePlan_Count==0)  
					{
						...
						Thread.sleep(1000);
						oPricePlan.PricePlanCreation(chargeUnit,Plan_code,Plan_code,"",Prov_System_Name,"","","","",locPlanType,"One Month"," "," ","",""," ","","Basic",""," "," ","","HJG",locSaveOrCancelBtn,locpricingBtn,Eff_date,locPrice,locPricingSaveBtn);
			...
			public void PR_2263() throws Exception
			{
				try
				{
					...
					if(Screen_Validation1.length()!=0  && Screen_Validation.length()!=0 )
					{
						...
						testLinkConnection.setsResult(TestLinkAPIResults.TEST_PASSED);
						testLinkConnection.setsNotes("Prerequisites- PRODUCT actions is Passed");
					}
					else
					{
						System.out.println("PR-2263 Failed");
						testLinkConnection.setsResult(TestLinkAPIResults.TEST_FAILED);
						testLinkConnection.setsNotes("Prerequisites- PRODUCT actions is Failed");
					}
				}
				catch(Exception e)
				{
			...
			public void PR_2267() throws Exception
			{
				try
				{
					...
					if(Screen_Validation.length()!=0)
					{
						...
						testLinkConnection.setsResult(TestLinkAPIResults.TEST_PASSED);
						testLinkConnection.setsNotes("Prerequisites- ALL Actions is Passed");
					}
					else
					{
						System.out.println("PR-2267 Failed");
						testLinkConnection.setsResult(TestLinkAPIResults.TEST_FAILED);
						testLinkConnection.setsNotes("Prerequisites- ALL Actions is Failed");
					}
				}
				catch(Exception e)
				{
			...
			public void PR_2273() throws Exception
			{
				try
				{
					...
					if(Screen_Validation1.length()!=0  && Screen_Validation.length()!=0 )
					{
						...
						testLinkConnection.setsResult(TestLinkAPIResults.TEST_PASSED);
						testLinkConnection.setsNotes("Provisioning system action- list all actions Mapping Is Passed");
					}
					else
					{
			...
			public void PR_4469() throws Exception
			{
				try
				{
					...
					if(Qstatus.equalsIgnoreCase(C_Status))        	
					{
						...
						testLinkConnection.setsResult(TestLinkAPIResults.TEST_PASSED);
						testLinkConnection.setsNotes("Reactivating Downgraded customer Is Passed");
					}
					else
					{
			...
			public void PR_4477() throws Exception
			{
				...
				try
				{
					...
					if(RequestCount>0)
					{
						...
						testLinkConnection.setsResult(TestLinkAPIResults.TEST_PASSED);
						testLinkConnection.setsNotes("verify received_date in provsion_request table Is Passed");
					}
					else
					{
						System.out.println("PR-4477 Failed");
						testLinkConnection.setsResult(TestLinkAPIResults.TEST_FAILED);
						testLinkConnection.setsNotes("verify received_date in provsion_request table is Failed");
					}
				}
				catch(Exception e)
				{
