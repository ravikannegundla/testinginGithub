...
public class Prov_ABV_Tc extends MQProvisioning

{
			...
			String Prov_System_Name="ABV";
			String Prov_System_Code="ABV";
			String Eff_date="23-04-2019";
			String Plan_code="ABVPLAN111" ;

			protected Prov_ABV_Tc(String sLogFileName) throws Exception 
			{
				super(sLogFileName);
