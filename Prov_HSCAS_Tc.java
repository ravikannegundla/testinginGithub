...
public class Prov_HSCAS_Tc  extends MQProvisioning

{
			...
			String Prov_System_Name="HSCAS";
			String Prov_System_Code="HSCAS";
			String Eff_date="06-08-2019";
			String Plan_code="HSCAS" ;

			protected Prov_HSCAS_Tc(String sLogFileName) throws Exception 
			{
				super(sLogFileName);
			...
			public void PR_2660() throws Exception
			{
				try
				{
					...
					if(PricePlan_Count==0)  
					{
						...
						Thread.sleep(1000);
						oPricePlan.PricePlanCreation(chargeUnit,Plan_code,Plan_code,"",Prov_System_Name,"","","","",locPlanType,"One Month"," "," ","",""," ","","Basic",""," "," ","","SDFS",locSaveOrCancelBtn,locpricingBtn,Eff_date,locPrice,locPricingSaveBtn);
